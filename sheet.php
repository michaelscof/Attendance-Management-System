...
<html lang="en">
  ...
  <div class="panel-group">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">Take Attendance
        <input type='submit' name='Back' value='Back' style="margin-left: 700px;width:150px;font-size: 14px"/></div>
      </form>
...
echo "<form method=\"post\" action=\"sheet.php\" accept-charset=\"UTF-8\">
